...
if __name__ == '__main__':
  ...
  #print 'test woo!' ##JS
  #print saturdayValence ##JS
  #print saturdayFvec[0:5] ##JS
  #print sum(saturdayFvec)
  ...
  foo1, foo2, foo3, foo4 = shift(tuesdayStoppedVec, saturdayStoppedVec, labMTvector, labMTwordList)
  print foo1[0:3]
  print foo2[0:3]
  print foo3[0:3]
  print foo4[0:3]
